...
(
    ...
    phiGrName_(dict.lookupOrDefault<word>("phiGr","phiGr")),
...
void Foam::darcyGradPressure::updateCoeffs()
{
    ...
    const fvsPatchField<scalar>& phiGr=
        patch().lookupPatchField<surfaceScalarField, scalar>(phiGrName_);
    ...
    gradient() = - (phi-phiGr-phiPc*activateCapillarity)/Mf/(patch().magSf());
...
void Foam::darcyGradPressure::write(Ostream& os) const
{
    ...
    writeEntryIfDifferent<word>(os, "phiGr", "phiGr", phiGrName_);
